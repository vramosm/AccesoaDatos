...
describe('Tripulante Management Component', () => {
  let comp: TripulanteComponent;
  let fixture: ComponentFixture<TripulanteComponent>;
  let service: TripulanteService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'tripulante', component: TripulanteComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(TripulanteComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.tripulantes?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
