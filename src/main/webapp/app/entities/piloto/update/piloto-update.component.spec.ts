...
describe('Piloto Management Update Component', () => {
  ...
  describe('save', () => {
    it('Should call update service on save for existing entity', () => {
      // GIVEN
      const saveSubject = new Subject<HttpResponse<Piloto>>();
      const piloto = { id: 123 };
      jest.spyOn(pilotoService, 'update').mockReturnValue(saveSubject);
    ...
    it('Should call create service on save for new entity', () => {
      ...
      jest.spyOn(pilotoService, 'create').mockReturnValue(saveSubject);
      jest.spyOn(comp, 'previousState');
      activatedRoute.data = of({ piloto });
      comp.ngOnInit();
