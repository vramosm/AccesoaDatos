...
describe('Piloto Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'piloto', component: PilotoComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.pilotos?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
