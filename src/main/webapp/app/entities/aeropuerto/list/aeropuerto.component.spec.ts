...
describe('Aeropuerto Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'aeropuerto', component: AeropuertoComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.aeropuertos?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
