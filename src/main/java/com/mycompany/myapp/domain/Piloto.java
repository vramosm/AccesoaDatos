...
public class Piloto implements Serializable {
    ...
    public void setVuelos(Set<Vuelo> vuelos) {
        if (this.vuelos != null) {
            this.vuelos.forEach(i -> i.setPiloto(null));
        }
        if (vuelos != null) {
            vuelos.forEach(i -> i.setPiloto(this));
        }
        this.vuelos = vuelos;
    }

    public Piloto vuelos(Set<Vuelo> vuelos) {
        this.setVuelos(vuelos);
        return this;
    }

    public Piloto addVuelo(Vuelo vuelo) {
        this.vuelos.add(vuelo);
        vuelo.setPiloto(this);
        return this;
    }

    public Piloto removeVuelo(Vuelo vuelo) {
